...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-CFXhTJTK.js
...
async function isProviderEnabled(provider) {
	...
	try {
		...
		return !!(await res.json()).external?.[provider];
	} catch {
		return false;
	}
}
...
function AuthProvider({ children }) {
	...
	const signInWithGoogle = (0, import_react.useCallback)(async () => {
		if (!await isProviderEnabled("google")) throw new Error("Google sign-in isn't enabled for this project yet. Enable the Google provider under Supabase Dashboard > Authentication > Sign In / Up, then try again.");
...
var $$splitComponentImporter$7 = () => import("./routes-tkJLbWoL.mjs");
...
var $$splitComponentImporter$6 = () => import("./dakphraser-DFzpUGbs.mjs");
...
var $$splitComponentImporter$5 = () => import("./downloader-I6r0uGUx.mjs");
...
var $$splitComponentImporter$4 = () => import("./guides-C7QmI9aQ.mjs");
...
var $$splitComponentImporter$3 = () => import("./ocr-me2K2HLT.mjs");
...
var $$splitComponentImporter$2 = () => import("./qr-Pp2-2XmG.mjs");
...
var $$splitComponentImporter$1 = () => import("./scanner-CxD5WUu7.mjs");
...
var $$splitComponentImporter = () => import("./guides_._slug-x_axC5X8.mjs");
