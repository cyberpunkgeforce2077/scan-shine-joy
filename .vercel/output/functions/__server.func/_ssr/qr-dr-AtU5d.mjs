...
import { n as PillButton, t as PageShell } from "./primitives-DolOPTwK.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/qr-dr-AtU5d.js
...
function QRPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PageShell, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "mb-7 flex gap-2 rounded-2xl border border-black/10 dark:border-white/10 bg-surface-1 p-1.5 shadow-sm",
