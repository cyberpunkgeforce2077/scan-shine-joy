...
//#region node_modules/.nitro/vite/services/ssr/assets/supabase-zTEQKr7L.js
var env = {
	"BASE_URL": "/",
	"DEV": true,
	"MODE": "production",
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-DiDWxjXO.js
			...
			if (newSession) {
				...
				(async () => {
					try {
						...
						if (!mounted) return;
						setProfile(p);
						import("./conversationStore-BRPMEPWS.mjs").then((m) => m.syncConversationsWithSupabase());
					} finally {
...
var $$splitComponentImporter$9 = () => import("./chat-CYOZZEtn.mjs");
...
var $$splitComponentImporter$8 = () => import("./dakphraser-D4cf7abg.mjs");
...
var $$splitComponentImporter$7 = () => import("./downloader-B8lJhhDd.mjs");
