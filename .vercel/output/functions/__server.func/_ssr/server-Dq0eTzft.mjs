...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DITtWT0v.mjs");
...
var manifest = {
	...
	"ad37d9fc47f6a79fabbfe5416fd4db00c1cf31225883df2c5573bf774f640765": {
		...
		importer: () => import("./dakphraser.functions-sxy1j9kW.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cg81w7KV.mjs").then((n) => n.t),
		import("./start-VySOKKwf.mjs"),
