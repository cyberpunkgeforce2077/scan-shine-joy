...
import { A as Image, B as Camera, C as MemoryStick, E as LoaderCircle, F as DatabaseBackup, H as BookOpen, M as Fish, P as Download, S as Menu, U as BatteryCharging, _ as Plus, a as Upload, f as Search, g as QrCode, i as UserRound, j as Gauge, k as Laptop, l as ShieldCheck, m as Scan, n as Wifi, r as WandSparkles, s as Thermometer, t as X, u as Settings, w as Mail, z as Check } from "../_libs/lucide-react.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-DUrBuFLi.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_dev_runtime = require_jsx_dev_runtime();
var _jsxFileName$6 = "/app/applet/src/components/ui/sonner.tsx";
var Toaster$1 = ({ ...props }) => {
...
var _jsxFileName$5 = "/app/applet/src/components/omni/ThemeProvider.tsx";
var KEY = "omni-theme";
					...
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", {
								...
								children: [busy === "google" ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(LoaderCircle, { className: "h-5 w-5 animate-spin" }, void 0, false, {
									fileName: _jsxFileName$2,
									lineNumber: 90,
									columnNumber: 36
							...
							emailMode ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("form", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Mail, { className: "h-4 w-4" }, void 0, false, {
									fileName: _jsxFileName$2,
									lineNumber: 123,
									columnNumber: 17
...
var styles_default = "/assets/styles-DX8zvnL6.css";
...
function MobileTopBar({ toggleDrawer }) {
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("header", {
		className: "fixed top-0 left-0 right-0 h-16 z-40 flex items-center justify-between px-4 bg-[#000000]",
		children: [
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", {
			...
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", {
					...
					children: chatTitle || profile?.username || "Vlad Bot"
				}, void 0, false, {
					fileName: _jsxFileName,
					lineNumber: 55,
					columnNumber: 9
...
function MobileDrawer({ isOpen, closeDrawer, openSettings }) {
	const { profile } = useAuth();
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(AnimatePresence, { children: isOpen && /* @__PURE__ */ (void 0)(motion.div, {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", {
					className: "text-xl font-medium text-[#e3e3e3]",
					children: "Assistant"
				}, void 0, false, {
					fileName: _jsxFileName,
					lineNumber: 94,
			...
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Plus, { className: "h-5 w-5" }, void 0, false, {
							fileName: _jsxFileName,
							lineNumber: 105,
							columnNumber: 13
						}, this), "New chat"]
					...
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
						className: "px-4 mb-2 text-sm font-semibold text-[#8e8e8e]",
					...
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(QrCode, { className: "h-5 w-5" }, void 0, false, {
									fileName: _jsxFileName,
									lineNumber: 121,
									columnNumber: 15
								}, this), " QR Code Scanner"]
							}, void 0, true, {
								fileName: _jsxFileName,
								lineNumber: 120,
								columnNumber: 13
							...
							/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, {
								...
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-3 hover:bg-white/10 rounded-full text-[#e3e3e3] font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Scan, { className: "h-5 w-5" }, void 0, false, {
									fileName: _jsxFileName,
									lineNumber: 124,
									columnNumber: 15
							...
							/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, {
								...
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-3 hover:bg-white/10 rounded-full text-[#e3e3e3] font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(WandSparkles, { className: "h-5 w-5" }, void 0, false, {
									fileName: _jsxFileName,
									lineNumber: 130,
									columnNumber: 15
								}, this), " DakPhraser"]
							...
							/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, {
								...
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-3 hover:bg-white/10 rounded-full text-[#e3e3e3] font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(BookOpen, { className: "h-5 w-5" }, void 0, false, {
									fileName: _jsxFileName,
									lineNumber: 136,
									columnNumber: 15
								}, this), " Field Guides"]
			...
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Settings, { className: "h-5 w-5 text-[#c4c7c5]" }, void 0, false, {
						fileName: _jsxFileName,
						lineNumber: 152,
						columnNumber: 11
					}, this)
...
function AuthGate({ children }) {
	...
	if (loading) return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(LoaderCircle, { className: "h-8 w-8 animate-spin text-[#c4c7c5]" }, void 0, false, {
			fileName: _jsxFileName,
			lineNumber: 199,
			columnNumber: 9
		}, this)
...
var $$splitComponentImporter$8 = () => import("./routes-CPpLFXEA.mjs");
...
var $$splitComponentImporter$7 = () => import("./dakphraser-Bz2-3bcX.mjs");
var Route$8 = createFileRoute("/dakphraser")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$6 = () => import("./downloader-Cfyw2yYT.mjs");
var Route$7 = createFileRoute("/downloader")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$5 = () => import("./guides-63iYltIS.mjs");
var Route$6 = createFileRoute("/guides")({
	head: () => ({ meta: [
...
var Route$5 = createFileRoute("/hub")({ beforeLoad: () => {
	throw redirect({ to: "/" });
} });
var $$splitComponentImporter$4 = () => import("./ocr-B6gLVfAx.mjs");
var Route$4 = createFileRoute("/ocr")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$3 = () => import("./qr-JuFSeYKB.mjs");
var Route$3 = createFileRoute("/qr")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$2 = () => import("./scanner-Csa6fl0x.mjs");
var Route$2 = createFileRoute("/scanner")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$1 = () => import("./settings-BZSLZCUg.mjs");
var Route$1 = createFileRoute("/settings")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./guides_._slug-CkS2vwEj.mjs");
...
var rootRouteChildren = {
	...
	DakphraserRoute: Route$8.update({
		id: "/dakphraser",
		path: "/dakphraser",
		getParentRoute: () => Route$10
	}),
	DownloaderRoute: Route$7.update({
		id: "/downloader",
		path: "/downloader",
		getParentRoute: () => Route$10
	}),
	GuidesRoute: Route$6.update({
		id: "/guides",
		path: "/guides",
		getParentRoute: () => Route$10
	}),
	HubRoute: Route$5.update({
		id: "/hub",
		path: "/hub",
		getParentRoute: () => Route$10
	}),
	OcrRoute: Route$4.update({
		id: "/ocr",
		path: "/ocr",
		getParentRoute: () => Route$10
	}),
	QrRoute: Route$3.update({
		id: "/qr",
		path: "/qr",
		getParentRoute: () => Route$10
	}),
	ScannerRoute: Route$2.update({
		id: "/scanner",
		path: "/scanner",
		getParentRoute: () => Route$10
	}),
...
//#endregion
export { getActiveConversationId as a, saveConversation as c, useAuth as d, guides as f, deleteConversation as i, searchConversations as l, Route as n, getConversation as o, searchGuides as p, createNewConversation as r, listConversations as s, router_exports as t, setActiveConversationId as u };
