...
import { i as createServerFn } from "./server-BHGZkICB.mjs";
import { a as stringType, i as objectType, n as enumType, t as arrayType } from "../_libs/zod.mjs";
import { B as Copy, C as Mic, G as Bot, J as ArrowRight, T as MessageSquare, U as Check, V as Clock, b as Plus, c as Trash2, d as Sparkles, h as Search, m as SendHorizontal, t as X, w as MicOff } from "../_libs/lucide-react.mjs";
import { n as useServerFn, t as createSsrRpc } from "./createSsrRpc-rJZ3fwQO.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { a as createNewConversation, c as getConversation, d as searchConversations, f as setActiveConversationId, l as listConversations, o as deleteConversation, p as syncConversationsWithSupabase, r as useNetworkStatus, s as getActiveConversationId, u as saveConversation } from "./router-BSOQQ5vt.mjs";
import { t as cn } from "./utils-C_uf36nf.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/chat-H0rYN4zJ.js
		...
		children: [
			empty ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						className: "text-center text-4xl sm:text-5xl font-medium tracking-tight text-foreground",
				...
				children: [
					messages.map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: m.role === "user" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "max-w-[85%] rounded-3xl rounded-tr-md bg-surface-2 px-5 py-3.5 text-[15px] leading-relaxed text-foreground",
							children: m.content
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "w-full text-[15px] leading-relaxed text-foreground",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-start gap-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "grid h-8 w-8 place-items-center rounded-full bg-surface-1 text-muted-foreground shrink-0",
					...
					busy && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-start gap-4",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-8 w-8 rounded-full bg-gradient-to-tr from-[#D7A2F6] to-[#8FA2ED] animate-spin shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-4 w-32 mt-2 rounded bg-surface-2 animate-pulse" })]
					}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("form", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex min-h-[56px] w-full items-end gap-3 rounded-[28px] bg-surface-1 p-2 shadow-[0_0_20px_rgba(215,162,246,0.15)] ring-1 ring-white/10 transition-all duration-300 focus-within:bg-surface-2 focus-within:shadow-[0_0_30px_rgba(215,162,246,0.25)] focus-within:ring-[#D7A2F6]/50",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								className: "grid h-12 w-12 shrink-0 place-items-center rounded-full text-muted-foreground hover:bg-black/5 dark:hover:bg-white/10 transition-all duration-200 cursor-pointer active:scale-[0.97] mb-0.5",
