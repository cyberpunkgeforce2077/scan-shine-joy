...
import { A as resolveManifestAssetLink, C as require_jsx_runtime, G as require_react, H as rootRouteId, L as isRedirect, M as _getRenderedMatches, N as executeRewriteInput, O as getScriptPreloadAttrs, P as invariant, R as isResolvedRedirect, U as isNotFound, a as isSsrResponse, c as stripSsrResponseBody, i as disposeSsrResponseDetached, j as resolveManifestCssLink, k as getStylesheetHref, n as bindSsrResponseToRequest, o as normalizeSsrResponse, p as RouterProvider, r as defineHandlerCallback, s as replaceSsrResponse, t as renderRouterToStream, z as parseRedirect } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cman9xg9.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DeDsnsJb.mjs").then((n) => n.t),
		import("./start-BpkuEOqD.mjs"),
