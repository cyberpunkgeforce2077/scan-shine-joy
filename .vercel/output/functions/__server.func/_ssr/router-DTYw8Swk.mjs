...
import { H as notFound, _ as createRootRouteWithContext, d as useRouterState, g as createFileRoute, h as lazyRouteComponent, l as Scripts, m as Outlet, p as createRouter, u as HeadContent, v as Link, z as redirect } from "../_libs/@tanstack/react-router+[...].mjs";
import { o as require_jsx_runtime } from "../_libs/@radix-ui/react-collection+[...].mjs";
import { t as createClient } from "../_libs/supabase__supabase-js.mjs";
import { A as Mail, B as Download, D as MessageSquare, F as Laptop, I as Image, J as Camera, L as Gauge, M as LoaderCircle, O as Menu, R as Fish, S as Music, V as DatabaseBackup, X as BookOpen, Z as BatteryCharging, a as Video, b as QrCode, d as Sun, g as Search, i as WandSparkles, k as MemoryStick, m as Settings, n as Wifi, o as UserRound, p as ShieldCheck, q as Check, r as WifiOff, s as Upload, t as X, u as Thermometer, v as Scan, w as Moon, x as Plus } from "../_libs/lucide-react.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-DTYw8Swk.js
...
function ThemeToggle({ variant = "icon", className = "" }) {
	...
	if (variant === "switch") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		...
		className: `relative inline-flex h-8 w-14 items-center rounded-full transition-colors duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary ${isDark ? "bg-[#2a2b2e]" : "bg-neutral-200"} ${className}`,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
			...
			className: `flex h-6 w-6 items-center justify-center rounded-full bg-white dark:bg-[#121314] shadow-sm transform ${isDark ? "translate-x-7 text-amber-300" : "translate-x-1 text-amber-500"}`,
			children: isDark ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Moon, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sun, { className: "h-3.5 w-3.5" })
		})
	});
	if (variant === "labeled") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: isDark ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Moon, { className: "h-4 w-4 text-amber-300" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sun, { className: "h-4 w-4 text-amber-500" })
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
			...
			children: isDark ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sun, { className: "h-4 w-4 text-amber-300 hover:text-amber-200 transition-colors" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Moon, { className: "h-4 w-4 text-neutral-800 hover:text-black transition-colors" })
		}, theme)
	});
}
			...
			if (newSession) {
				...
				(async () => {
					try {
						...
						if (!mounted) return;
						setProfile(p);
						import("./conversationStore-CZBkAaLO.mjs").then((m) => m.syncConversationsWithSupabase());
					} finally {
...
var styles_default = "/assets/styles-B-lmuteY.css";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeToggle, { variant: "icon" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					to: "/settings",
					title: "User Profile",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: isOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "h-5 w-5 text-primary" }), "New chat"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						onClick: () => {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-3",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "grid h-8 w-8 place-items-center rounded-xl bg-purple-500/20 text-purple-400",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Music, { className: "h-4 w-4" })
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-semibold",
								children: "Text to Music"
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-[10px] font-bold tracking-wider uppercase text-purple-400 bg-purple-500/20 px-2 py-0.5 rounded-full",
							children: "Headliner"
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-3",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "grid h-8 w-8 place-items-center rounded-xl bg-blue-500/20 text-blue-400",
							...
							className: "text-[10px] font-bold tracking-wider uppercase text-blue-400 bg-blue-500/20 px-2 py-0.5 rounded-full",
							children: "New"
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageSquare, { className: "h-5 w-5 text-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Vlad Bot" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/downloader",
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-2.5 hover:bg-black/5 dark:hover:bg-white/10 rounded-2xl text-foreground font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Download, { className: "h-5 w-5 text-emerald-400" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Media Downloader" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/scanner",
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-2.5 hover:bg-black/5 dark:hover:bg-white/10 rounded-2xl text-foreground font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scan, { className: "h-5 w-5 text-amber-400" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Doc Scanner" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/qr",
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-2.5 hover:bg-black/5 dark:hover:bg-white/10 rounded-2xl text-foreground font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(QrCode, { className: "h-5 w-5 text-pink-400" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "QR Code Studio" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/ocr",
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-2.5 hover:bg-black/5 dark:hover:bg-white/10 rounded-2xl text-foreground font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image, { className: "h-5 w-5 text-cyan-400" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Local OCR" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/dakphraser",
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-2.5 hover:bg-black/5 dark:hover:bg-white/10 rounded-2xl text-foreground font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WandSparkles, { className: "h-5 w-5 text-purple-400" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "DakPhraser" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/guides",
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-2.5 hover:bg-black/5 dark:hover:bg-white/10 rounded-2xl text-foreground font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookOpen, { className: "h-5 w-5 text-orange-400" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Field Guides" })]
							})
						]
					})
				]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeToggle, { variant: "labeled" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					to: "/settings",
					onClick: closeDrawer,
					title: "User Profile",
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Settings, { className: "h-5 w-5 text-muted-foreground" })
					]
				})]
			})
		]
...
var $$splitComponentImporter$12 = () => import("./routes-DAmWjb5Q.mjs");
var Route$13 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$12, "component") });
var $$splitComponentImporter$11 = () => import("./chat-Ct_Ke6TJ.mjs");
var Route$12 = createFileRoute("/chat")({
	head: () => ({ meta: [
		{ title: "Assistant" },
		{
			name: "description",
...
var $$splitComponentImporter$10 = () => import("./dakphraser-HPxYLmuV.mjs");
var Route$11 = createFileRoute("/dakphraser")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$9 = () => import("./downloader-DIMZmKMP.mjs");
var Route$10 = createFileRoute("/downloader")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$8 = () => import("./guides-NTc1bGLO.mjs");
var Route$9 = createFileRoute("/guides")({
	head: () => ({ meta: [
...
var Route$8 = createFileRoute("/hub")({ beforeLoad: () => {
	throw redirect({ to: "/" });
} });
var $$splitComponentImporter$7 = () => import("./music-DCf55FXH.mjs");
var Route$7 = createFileRoute("/music")({
	head: () => ({ meta: [
		{ title: "Text-to-Music Studio — OmniSuite" },
		{
			name: "description",
			content: "Synthesize original music, beats, and soundscapes from natural text prompts with Google AI & multi-track audio generation."
		},
		{
			property: "og:title",
			content: "Text-to-Music Studio — OmniSuite"
		},
		{
			property: "og:description",
...
var $$splitComponentImporter$6 = () => import("./ocr-V3Bzb2Sw.mjs");
var Route$6 = createFileRoute("/ocr")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$5 = () => import("./qr-DVnO6F4f.mjs");
var Route$5 = createFileRoute("/qr")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$4 = () => import("./scanner-Bs0eeHsU.mjs");
var Route$4 = createFileRoute("/scanner")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$3 = () => import("./settings-DIshgz1y.mjs");
var Route$3 = createFileRoute("/settings")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./video-DuFBnZqF.mjs");
var Route$2 = createFileRoute("/video")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
...
var $$splitComponentImporter = () => import("./guides_._slug-Bxitn2oG.mjs");
...
var rootRouteChildren = {
	...
	ChatRoute: Route$12.update({
		id: "/chat",
		path: "/chat",
		getParentRoute: () => Route$14
	}),
	DakphraserRoute: Route$11.update({
		id: "/dakphraser",
		path: "/dakphraser",
		getParentRoute: () => Route$14
	}),
	DownloaderRoute: Route$10.update({
		id: "/downloader",
		path: "/downloader",
		getParentRoute: () => Route$14
	}),
	GuidesRoute: Route$9.update({
		id: "/guides",
		path: "/guides",
		getParentRoute: () => Route$14
	}),
	HubRoute: Route$8.update({
		id: "/hub",
		path: "/hub",
		getParentRoute: () => Route$14
	}),
	MusicRoute: Route$7.update({
		id: "/music",
		path: "/music",
		getParentRoute: () => Route$14
	}),
	OcrRoute: Route$6.update({
		id: "/ocr",
		path: "/ocr",
		getParentRoute: () => Route$14
	}),
	QrRoute: Route$5.update({
		id: "/qr",
		path: "/qr",
		getParentRoute: () => Route$14
	}),
	ScannerRoute: Route$4.update({
		id: "/scanner",
		path: "/scanner",
		getParentRoute: () => Route$14
	}),
