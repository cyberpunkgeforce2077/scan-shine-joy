...
import { B as DatabaseBackup, C as Moon, D as Menu, E as MessageSquare, F as Image, G as Camera, I as Gauge, J as BatteryCharging, L as Fish, O as MemoryStick, P as Laptop, W as Check, _ as Scan, a as UserRound, b as Plus, f as ShieldCheck, h as Search, i as WandSparkles, j as LoaderCircle, k as Mail, l as Thermometer, n as Wifi, o as Upload, p as Settings, q as BookOpen, r as WifiOff, t as X, u as Sun, x as Music, y as QrCode, z as Download } from "../_libs/lucide-react.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-C5t8w-YE.js
			...
			if (newSession) {
				...
				(async () => {
					try {
						...
						if (!mounted) return;
						setProfile(p);
						import("./conversationStore-DZevKmuV.mjs").then((m) => m.syncConversationsWithSupabase());
					} finally {
...
var styles_default = "/assets/styles-S1WxQl4b.css";
			...
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, {
						to: "/music",
						onClick: closeDrawer,
						className: "w-full flex items-center justify-between px-4 py-3 bg-gradient-to-r from-purple-500/15 via-pink-500/10 to-transparent border border-purple-500/25 hover:border-purple-500/50 rounded-2xl text-foreground font-semibold transition-all duration-200 cursor-pointer active:scale-[0.97] mb-4 shadow-xs",
						children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
							className: "flex items-center gap-3",
							children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
								className: "grid h-8 w-8 place-items-center rounded-xl bg-purple-500/20 text-purple-400",
								children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Music, { className: "h-4 w-4" }, void 0, false, {
									fileName: _jsxFileName,
									lineNumber: 168,
									columnNumber: 17
								}, this)
...
var $$splitComponentImporter$11 = () => import("./routes-Acz32kBl.mjs");
var Route$12 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$11, "component") });
var $$splitComponentImporter$10 = () => import("./chat-0nqYOoxr.mjs");
...
var $$splitComponentImporter$9 = () => import("./dakphraser-COMIshFa.mjs");
var Route$10 = createFileRoute("/dakphraser")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$8 = () => import("./downloader-sU9AfM1v.mjs");
var Route$9 = createFileRoute("/downloader")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$7 = () => import("./guides-D61qeSb_.mjs");
...
var Route$7 = createFileRoute("/hub")({ beforeLoad: () => {
	throw redirect({ to: "/" });
} });
var $$splitComponentImporter$6 = () => import("./music-BptWBLuY.mjs");
var Route$6 = createFileRoute("/music")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$5 = () => import("./ocr-Cxthrd6o.mjs");
...
var $$splitComponentImporter$4 = () => import("./qr-DWtLdI77.mjs");
...
var $$splitComponentImporter$3 = () => import("./scanner-Biez3yfX.mjs");
...
var rootRouteChildren = {
	...
	DakphraserRoute: Route$10.update({
		id: "/dakphraser",
		path: "/dakphraser",
		getParentRoute: () => Route$13
	}),
	DownloaderRoute: Route$9.update({
		id: "/downloader",
		path: "/downloader",
		getParentRoute: () => Route$13
	}),
	GuidesRoute: Route$8.update({
		id: "/guides",
		path: "/guides",
		getParentRoute: () => Route$13
	}),
	HubRoute: Route$7.update({
		id: "/hub",
		path: "/hub",
		getParentRoute: () => Route$13
	}),
	MusicRoute: Route$6.update({
		id: "/music",
		path: "/music",
		getParentRoute: () => Route$13
	}),
