...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-Cg81w7KV.js
			...
			if (newSession) {
				...
				(async () => {
					try {
						...
						if (!mounted) return;
						setProfile(p);
						import("./conversationStore-NbKy59GC.mjs").then((m) => m.syncConversationsWithSupabase());
					} finally {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageSquare, { className: "h-5 w-5" }), " Vlad Bot"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/qr",
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-3 hover:bg-white/10 rounded-full text-[#e3e3e3] font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(QrCode, { className: "h-5 w-5" }), " QR Code Scanner"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/scanner",
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-3 hover:bg-white/10 rounded-full text-[#e3e3e3] font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scan, { className: "h-5 w-5" }), " Document Scanner"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/ocr",
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-3 hover:bg-white/10 rounded-full text-[#e3e3e3] font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image, { className: "h-5 w-5" }), " Image OCR"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/dakphraser",
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-3 hover:bg-white/10 rounded-full text-[#e3e3e3] font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WandSparkles, { className: "h-5 w-5" }), " DakPhraser"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/downloader",
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-3 hover:bg-white/10 rounded-full text-[#e3e3e3] font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Download, { className: "h-5 w-5" }), " Media Downloader"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/guides",
								onClick: closeDrawer,
								className: "w-full flex items-center gap-3 px-4 py-3 hover:bg-white/10 rounded-full text-[#e3e3e3] font-medium transition-all duration-200 cursor-pointer active:scale-[0.97]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookOpen, { className: "h-5 w-5" }), " Field Guides"]
							})
						]
					})
				]
...
var $$splitComponentImporter$9 = () => import("./chat-BElX30v2.mjs");
...
var $$splitComponentImporter$8 = () => import("./dakphraser-DUCQ0Xop.mjs");
...
var $$splitComponentImporter$7 = () => import("./downloader-D7RyfUSf.mjs");
...
var $$splitComponentImporter$2 = () => import("./settings-DQ0fOJTj.mjs");
...
var $$splitComponentImporter = () => import("./guides_._slug-B-go7T1k.mjs");
