...
import { A as resolveManifestAssetLink, B as parseRedirect, C as require_jsx_runtime, G as require_react, H as rootRouteId, L as isDangerousProtocol, M as _getRenderedMatches, N as executeRewriteInput, O as getScriptPreloadAttrs, U as isNotFound, a as isSsrResponse, c as stripSsrResponseBody, i as disposeSsrResponseDetached, j as resolveManifestCssLink, k as getStylesheetHref, n as bindSsrResponseToRequest, o as normalizeSsrResponse, p as RouterProvider, r as defineHandlerCallback, s as replaceSsrResponse, t as renderRouterToStream, z as isRedirect } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DXCfd2ul.mjs");
...
var manifest = {
	...
	"ad37d9fc47f6a79fabbfe5416fd4db00c1cf31225883df2c5573bf774f640765": {
		...
		importer: () => import("./dakphraser.functions-h09TB_eb.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C5t8w-YE.mjs").then((n) => n.t),
		import("./start-BgUGRF4h.mjs"),
