...
//#region node_modules/.nitro/vite/services/ssr/assets/primitives-CqR_vGeG.js
...
function PlushCard({ children, className, interactive = true, delay = 0 }) {
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, {
		...
		className: cn("rounded-[24px] bg-surface-1 group p-5 transition-[box-shadow,transform,border-color] duration-300 border border-transparent hover:border-black/20 dark:hover:border-white/20 shadow-sm", className),
		children
	}, void 0, false, {
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
		...
		children: [
			eyebrow && /* @__PURE__ */ (void 0)("span", {
				className: "inline-flex rounded-full bg-surface-1 px-3.5 py-1 text-[11px] font-bold uppercase tracking-[0.14em] text-primary",
				children: eyebrow
			}, void 0, false, {
				fileName: _jsxFileName,
				lineNumber: 52,
			...
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", {
				className: "mt-3 font-display text-3xl font-semibold tracking-[-0.03em] text-foreground sm:text-4xl",
				children: title
			}, void 0, false, {
				fileName: _jsxFileName,
				lineNumber: 56,
			...
			description && /* @__PURE__ */ (void 0)("p", {
				className: "mt-3 max-w-xl text-sm leading-relaxed text-muted-foreground sm:text-[15px]",
...
function PillButton({ children, variant = "primary", className, ...props }) {
	const variants = {
		...
		ghost: "text-muted-foreground hover:bg-black/5 dark:hover:bg-white/10 hover:text-foreground active:scale-[0.97]",
		outline: "border border-black/10 dark:border-white/10 bg-surface-1 text-foreground hover:bg-black/5 dark:hover:bg-white/10 active:scale-[0.97]"
	};
