...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-JaEDe7Bn.mjs");
...
var manifest = {
	...
	"ad37d9fc47f6a79fabbfe5416fd4db00c1cf31225883df2c5573bf774f640765": {
		...
		importer: () => import("./dakphraser.functions-Cvzi7rTa.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-hmf0KEm-.mjs").then((n) => n.t),
		import("./start-C8HOBb5o.mjs"),
