...
//#region node_modules/.nitro/vite/services/ssr/assets/supabase-CtJSqkYs.js
var env = {
	"BASE_URL": "/",
	"DEV": false,
	"MODE": "production",
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-BSOQQ5vt.js
			...
			if (newSession) {
				...
				(async () => {
					try {
						...
						if (!mounted) return;
						setProfile(p);
						import("./conversationStore-B9z-aTxl.mjs").then((m) => m.syncConversationsWithSupabase());
					} finally {
	...
	(0, import_react.useEffect)(() => {
		function updateTitle() {
			...
			if (id) {
				...
				if (conv && first) {
					setChatTitle(conv.title !== "Untitled Chat" ? conv.title : first.content.slice(0, 30) + (first.content.length > 30 ? "..." : ""));
					return;
				}
			}
			setChatTitle(null);
...
var $$splitComponentImporter$10 = () => import("./routes-Cjh3cukx.mjs");
var Route$11 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$10, "component") });
var $$splitComponentImporter$9 = () => import("./chat-H0rYN4zJ.mjs");
...
var $$splitComponentImporter$8 = () => import("./dakphraser-CEnw-tcm.mjs");
...
var $$splitComponentImporter$7 = () => import("./downloader-BI2mHEtG.mjs");
...
var $$splitComponentImporter$6 = () => import("./guides-9IOQ4aY7.mjs");
...
var $$splitComponentImporter$5 = () => import("./ocr-qnzGHdI7.mjs");
...
var $$splitComponentImporter$4 = () => import("./qr-dr-AtU5d.mjs");
...
var $$splitComponentImporter$3 = () => import("./scanner-Bpx2porV.mjs");
