...
export function AuthScreen() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4">
      <div aria-hidden className="warm-canvas-backdrop pointer-events-none fixed inset-0 z-0" />
      ...
      >
        <div className="glass-bar rounded-3xl px-7 py-10 sm:px-10 sm:py-12">
          <div className="flex flex-col items-center text-center">
            <span className="relative grid h-[68px] w-[68px] place-items-center rounded-2xl border border-primary/20 bg-primary-container text-primary shadow-[var(--shadow-plush)]">
              <StudioMark className="relative h-9 w-9" />
            </span>
